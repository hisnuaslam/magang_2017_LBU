<%-- 
    Document   : form_013
    Created on : Feb 16, 2017, 12:11:59 PM
    Author     : hisnuaslam
--%>
...
<html>
    <head>
        ...
        <title>Form 13 - Daftar Rincian Cadangan Kerugian Penurunan Nilai Aset Keuangan</title>
        <link rel="stylesheet"
                    ...
                    <div class="box box-solid">
                        <div class="box-body">
                            <div class="box-header">
                                <h3 class="box-title">FORM 13 - Daftar Rincian Cadangan Kerugian Penurunan Nilai Aset Keuangan</h3>
                            </div>
                            <div class="box-body">
                                <form role="form">
                                    <div class="form-group">
                                        <table class="table table-condensed table-hover">
                                            <tr>
                                                <td><label>Jenis Aset</label></td>
                                                <td><select name="jenis_aset" class="form-control">
                                                        <option value="150">Perangkat Lunak(Computer Software)</option>
                                                        <option value="151">Hak Paten</option>
                                                        <option value="152">Goodwill</option>
                                                        <option value="160">Lainnya</option>
                                                    </select></td>
                                            </tr>
                                            <tr>
                                                <td><label>Tanggal Perolehan</label></td>
                                                <td>
                                                    <div class="input-group date">
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-calendar"></i>
                                                        </div>
                                                        <input type="text" name="tanggal_perolehan"
                                            ...
                                            <tr>
                                                <td><label>Akumulasi Amortisasi</label></td>
                                                <td>
                                                    <div class="input-group">
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-money"></i>
