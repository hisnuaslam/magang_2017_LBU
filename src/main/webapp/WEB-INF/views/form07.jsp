<%-- 
    Document   : form_07
    Created on : Feb 14, 2017, 9:53:13 AM
    Author     : hisnuaslam
--%>
...
<html>
    <head>
        ...
        <title>Form 07 - DAFTAR RINCIAN SURAT BERHARGA</title>
        <link rel="stylesheet"
                    ...
                    <div class="box box-solid">
                        <div class="box-body">
                            <div class="box-header">
                                <h3 class="box-title">FORM 07 - DAFTAR RINCIAN SURAT BERHARGA</h3>
                            </div>
                            <div class="box-body">
                                <form role="form">
                                    <div class="form-group">
                                        ...
                                        <tr>
                                         ...
                                         <tr id="trSifat1">
                                             <td></td>
                                            <td>
                                            <select id="ssSifat" name="sifat" class="form-control">
                                                    <option value="1">Opsi Beli (Call Option)</option>
                                                    <option value="2">Opsi Jual (Put Option)</option>
                                                    <option value="ooSifat1">Opsi Konversi (Convertible Option)</option>
                                        ...
                                        <td>
                                            <select name="golongan_penerbit" class="form-control">
                                        ...
                                        <tr><td>
                                                &nbsp;&nbsp;&nbsp;&nbsp;Status Penerbit / Tertarik
                                            </td>
                                            <td>
                                                <select name="status_pihak_penerbit" class="form-control">
                                        ...
                                        <tr><td>
                                            ...
                                            <tr>
                                                <td><label>Harga Perolehan</label></td>
                                                <td>
                                                    <div class="input-group">
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-money"></i>
